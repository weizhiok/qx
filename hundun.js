...
body = body.replace(/\"play_tip_msg\"\:\"\w+\"/g,'"play_tip_msg":""');
...
body = body.replace(/\"is_visible\"\:\s1,\s\"will_expire_value\"\:/g,'"is_visible":0,"will_expire_value":');
...
body = body.replace(/\"is_free_4_user\"\:\w+/g,'"is_free_4_user":true');
